...
axes[0,0].bar(scenarios, [gt_metrics['sc_ratio_battery'], easy_metrics['sc_ratio_battery'], xgb_metrics['sc_ratio_battery']], color=colors)
axes[0,0].set_title('Self-Consumption Ratio with Battery (%)', fontweight='bold')
...
# Autarky
axes[0,1].bar(scenarios, [gt_metrics['autarky_battery'], easy_metrics['autarky_battery'], xgb_metrics['autarky_battery']], color=colors)
axes[0,1].set_title('Autarky with Battery (%)', fontweight='bold')
...
axes[1,0].bar(scenarios, [gt_metrics['grid_reduction_pct'], easy_metrics['grid_reduction_pct'], xgb_metrics['grid_reduction_pct']], color=colors)
axes[1,0].set_title('Grid Import Reduction (%)', fontweight='bold')
...
axes[1,1].bar(scenarios, [gt_metrics['annual_cycles'], easy_metrics['annual_cycles'], xgb_metrics['annual_cycles']], color=colors)
axes[1,1].set_title('Annual Battery Cycles', fontweight='bold')
...
plt.suptitle('Battery Simulation Results - Project A (80 kWh / 40 kW Battery)', fontsize=14, fontweight='bold', y=1.02)
plt.tight_layout()
